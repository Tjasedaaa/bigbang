...
if ( ! function_exists( 'bigbang_setup' ) ) :
	...
	function bigbang_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'bigbang' ),
		) );
 ...
 */
function bigbang_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'bigbang_content_width', 640 );
}
add_action( 'after_setup_theme', 'bigbang_content_width', 0 );
...
function bigbang_scripts() {
	...
	wp_enqueue_script( 'bigbang-scripts', get_template_directory_uri() . '/js/app.min.js', array(), '1.0', true );

	wp_enqueue_script( 'bigbang-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'bigbang-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
